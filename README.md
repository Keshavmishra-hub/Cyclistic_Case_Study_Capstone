...
## Introduction
In this case study, I will perform many real-world tasks of a junior data analyst at a fictional company, Cyclistic. In order to answer the key business questions, I will follow the steps of the data analysis process: [Ask](https://github.com/Keshavmishra-hub/Cyclistic_Case_Study_Capstone/blob/main/README.md#ask), [Prepare](https://github.com/Keshavmishra-hub/Cyclistic_Case_Study_Capstone/blob/main/README.md#prepare), [Process](https://github.com/Keshavmishra-hub/Cyclistic_Case_Study_Capstone/blob/main/README.md#process), [Analyze](https://github.com/Keshavmishra-hub/Cyclistic_Case_Study_Capstone/blob/main/README.md#analyze-and-share), [Share](https://github.com/Keshavmishra-hub/Cyclistic_Case_Study_Capstone/blob/main/README.md#analyze-and-share), and [Act](https://github.com/Keshavmishra-hub/Cyclistic_Case_Study_Capstone/blob/main/README.md#act).
### Quick links:
